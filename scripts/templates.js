  ...
  return `<div class="task-card" 
              ...
              data-status="${task.status}">
                <div class= "task-type-wrapper">
                  ...
                  <svg class="drag-and-drop-mobile" onclick="drag-and-drop-dropdown("${task.apiKey}")" width="24" height="26" viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg">
