  ...
  return `<div class="task-card" 
              ...
              data-status="${task.status}">
                <div class= "task-type-wrapper">
                  ...
                  <div class= "dropdown-tasks-content"> 
                  <svg class="drag-and-drop-mobile" onclick="noClose(event); dragAndDropDropdown('${task.apiKey}', '${task.status}'); closeDropDownTasks('${task.apiKey}')" id="task-${task.apiKey}" width="24" height="26" viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="dropdown-tasks-menu d-none" id="dropdown-${task.apiKey}">
                   ...
                   <div class="dropdown-text">Move to</div>
                    ...
                    <div id="tasks-todo-${task.apiKey}" class="">
                   <div class="dropdown-tasks-text">To-Do</div>
                   </div>
                   <div id= "tasks-inprogress-${task.apiKey}" class="">
                   <div class="dropdown-tasks-text">In progress</div>
                   </div>
                   <div id="tasks-awaitfeedback-${task.apiKey}" class="">
                   <div class="dropdown-tasks-text">Await feedback</div>
                   </div>
                    <div id="tasks-done-${task.apiKey}" class="">
