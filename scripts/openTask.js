            ...
            <section class="overlay-task-body">
                ...
                <span>Assigned To:</span>
                    ...
                    <div class="task-overlay-footer-buttons">
                                ...
                                <div class="floating-edit-wrapper" onclick="overlayEditTask(task)">
                                    <div>
                                ...
                                <div class="floating-delete-wrapper" onclick="deleteTask(${task.apiKey})">
                                    <div>
...
function overlayDeleteTask(apiKey){
    deleteDataFromApi("tasks", apiKey);
    initBoard();
}


function overlayEditTask(apiKey){
