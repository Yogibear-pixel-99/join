...
function getSingleContactTemp(nameRow, firstLetterArray){
    return `<div class="single-contact" id="contact-${nameRow.id}" onclick="openContactInFloatMenu('${nameRow.id}', '${firstLetterArray}'); getInfosForEditMenu('${nameRow.id}', '${firstLetterArray}')">
                    ...
                    <div class="floating-contact-header">
                        ...
                        <div class="floating-name-wrapper">
                            ...
                            <div class="floating-edit-delete-wrapper">
                                <div class="floating-edit-wrapper" onclick="openEditContact()">
                                    <div>
