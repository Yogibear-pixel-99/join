...
function renderSubtaskInForm(subtask) {
  return `<div id="${subtask}" class="subtask-container-wrapper">
            ...
            <svg onmousedown="focusToSubtaskInput('input-${subtask}')" class="single-subtask-icon" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
